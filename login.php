                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <form action="php/authenticate.php" method="post" class="">
                                    <div class="card-body card-block">
                                            
                                            
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">National ID Number</label>
                                                </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-7">
                                                    <input type="phone" id="phoneNumber" name="phoneNumber" placeholder="" class="form-control">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-success btn-sm" name="login">
