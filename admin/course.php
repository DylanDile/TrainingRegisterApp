    ...
    <div class="row">
        <div class="col-md-10">
         <!-- DATA TABLE -->
            ...
            <div class="card">
                <div class="card-header">Today's Register</div>
                    <div class="card-body card-block">
                        <form action="php/todayRegister.php" method="POST">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select name="course" class="form-control input-sm">
                                        ...
                                        <option value="0" >Basic ICDL</option>
                            ...
                            <div class="form-actions form-group">
                                <button type="submit" class="btn btn-success btn-sm" name="group">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
