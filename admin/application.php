...
include_once 'header.php'; ?>
                <div class="row">
                            <div class="col-md-11">
                                <!-- DATA TABLE -->
                                <h2 class="title-5 m-b-35">All Applicants</h2>
                        ...
                        <?php
                            include_once 'php/conn.php';
                                $select = mysqli_query($conn,"SELECT * FROM `applications` ");
                                    ...
                                    for ($i=0; $i < $rows; $i++) {
                                        ...
                                        ?>
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="date2"><?php echo $sex; ?></td>
                                                <td class="date2"><?php echo $category; ?></td>
                                                ...
                                                <td class="table-data-feature">
                                                    ...
                                                    <div class="table-data-feature">
                                                       ...
                                                       <a href="<?php echo 'scheduling.php?app_id='.$app_id?>" class="item" data-toggle="tooltip" data-placement="top" title="Accept this Application">
                                                            <i class="zmdi zmdi-edit"></i></a>
                                                       <!-- <a href="<?php //echo 'rejected.php?app_id='.$app_id?>" class="item" data-toggle="tooltip" data-placement="top" title="reject">
