...
?>
    ...
    <div class="row">
        <div class="col-md-10">
         <!-- DATA TABLE -->
            <h2 class="title-5 m-b-35">Add Users</h2>
            <div class="card">
                        ...
                        <form action="php/parameter.php" method="POST">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="email" id="userEmail" name="userEmail" placeholder="Enter User Email" class="form-control">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="password" id="userPassword" name="userPassword"placeholder="Enter User Password" class="form-control">
                                </div>
                            </div>
                            <hr>
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <select name="userRole" id="userRole" class="form-control">
                                        ...
                                        <?php
                                        $select = mysqli_query($conn,"SELECT * FROM `roles`");
                                        ...
                                        ?>
                                        <option value="<?php echo $id['roleID']; ?>"><?php echo $role; ?></option>
                                    <?php }?>
                                    </select>
                                </div>
                            </div>
