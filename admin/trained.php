...
include_once 'header.php'; ?>
                <div class="row">
                            <div class="col-md-11">
                                <!-- DATA TABLE -->
                                <h2 class="title-5 m-b-35">Trained Students</h2>
                        ...
                        <?php
                            include_once 'php/conn.php';
                                $select = mysqli_query($conn,"SELECT * FROM `applicationshistory`  WHERE `status` = 'trained' ");
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td class="table-data-feature">
                                                    <div class="table-data-feature">
                                                       ...
                                                       <a href="<?php echo 'scheduling.php?app_id='.$app_id?>" class="item" data-toggle="tooltip" data-placement="top" title="Add to register">
